...
class MultivariateOnlineSummarizer extends MultivariateStatisticalSummary with Serializable {
  ...
  private var n = 0
  // mean for each dimension till now
  private var currMean: Array[Double] = _
  // square mean for each dimension till now
  private var currM2n: Array[Double] = _
//  private var currM2: Array[Double] = _
//  private var currL1: Array[Double] = _
  private var totalCnt: Long = 0

  // can we assume each data sample has weight 1?
...
//  private[spark]
  def add(instance: Vector, weight: Double): this.type = {
    ...
    /**
      * GHANDZHIPENG==ONLY non-zero elements are averaged. THAT's called standardization. This is a crap!
      */
